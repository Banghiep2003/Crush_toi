...
document.querySelector('.Description .modal-body').innerHTML = 'Mình thích cậu đó <i class="fas fa-heart"></i> ';
var author = document.querySelector('.author .me');author.style.opacity = "0.5";

author.innerHTML = "Mọi thắc mắc bạn có thể liên hệ<a href='https://www.facebook.com/ba.nghiep.ne'>Bá Nghiệp<a>";
